    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: '/app/json-diff',
          icon: IconGitCompare,
          description: "Compare two JSON documents semantically, ignoring key order and formatting.",
        },
        {
          title: "JSONPath Playground",
          url: '/app/jsonpath-playground',
          icon: IconZoomCode,
          description: "Query JSON documents with JSONPath or JMESPath expressions.",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: IconLockAccess,
          description: "Convert Unix permissions between checkboxes, octal, and symbolic.",
        },
        {
          title: "Timezone Converter",
          url: '/app/timezone-converter',
          icon: IconWorld,
          description: "Convert a time across many timezones for meeting planning.",
        },
        {
          title: "LLM Token Counter",
          url: '/app/token-counter',
          icon: IconAbacus,
          description: "Count LLM tokens and estimate API cost for any text.",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: '/app/markdown-table-generator',
          icon: IconTable,
          description: "Build Markdown and HTML tables in a spreadsheet-like editor.",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: IconWebhook,
          description: "Capture and inspect incoming webhook requests in real time.",
        },
        {
          title: "WebSocket Tester",
          url: '/app/websocket-tester',
          icon: IconPlugConnected,
          description: "Connect to WebSocket endpoints and send, receive, and inspect messages live.",
        },
        {
          title: "Whois Lookup",
          url: '/app/whois-lookup',
          icon: IconWorldSearch,
          description: "Look up domain and IP registration details via RDAP/WHOIS.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: '/app/code-screenshot',
          icon: IconPhotoCode,
          description: "Turn source code into beautiful shareable images.",
        },
        {
          title: "CSS Generators",
          url: '/app/css-generators',
          icon: IconPalette,
        ...
        },
        {
          ...
          url: '/app/favicon-generator',
          icon: IconFavicon,
          description: "Generate favicons, app icons and manifest snippets.",
        },
        {
          title: "Keycode Inspector",
          url: '/app/keycode-inspector',
          icon: IconKeyboard,
          description: "Inspect JavaScript keyboard events: key, code, and modifiers.",
        },
      ],
    },
    {
