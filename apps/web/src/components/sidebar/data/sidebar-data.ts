  ...
  navGroups: [
    ...
    },
    {
      ...
      items: [
        {
          title: 'PDF Unlocker',
          url: '/app/pdf-unlocker',
          icon: IconFileTypePdf,
          description: 'Remove the open password from a PDF and download an unlocked copy. Runs locally in your browser.',
          hiddenOnMobile: true,
          badge: 'new',
        },
        {
          ...
          url: '/app/pdf-locker',
          icon: IconLock,
          description: 'Password-protect a PDF with AES-256 and download a locked copy. Runs locally in your browser.',
          hiddenOnMobile: true,
          badge: 'new',
        },
        {
          title: 'PDF Splitter',
          url: '/app/pdf-splitter',
          icon: IconFileTypePdf,
          description: 'Split a PDF into individual pages or extract a page range as a new PDF. Runs locally in your browser.',
          hiddenOnMobile: true,
          badge: 'new',
        },
        {
