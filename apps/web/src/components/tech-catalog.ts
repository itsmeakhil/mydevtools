// Plain data module (NO "use client") so Server Components can read TECH_CATALOG.
// A "use client" module exports client references, not real values, on the server
// side — reading TECH_CATALOG.find() there throws (500 on populated profiles).
