...
export function ExperienceBuilder({ experiences, onChange, flat = false }: ExperienceBuilderProps) {
    ...
    <div className="flex items-center justify-between px-5 pt-4 pb-3">
      <div className="space-y-0.5 flex-1 min-w-0">
        ...
        <p className="text-xs text-muted-foreground truncate">
          {isCollapsed ? summary : 'Your professional journey and career highlights.'}
        </p>
      </div>
