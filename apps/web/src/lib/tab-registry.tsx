...
const TAB_REGISTRY: Record<string, React.ComponentType> = {
  ...
  '/app/beautify-minify': dynamic(() => import('@/app/app/beautify-minify/page'), { ssr: false, loading }),
  '/app/string-case-converter': dynamic(() => import('@/app/app/string-case-converter/page'), { ssr: false, loading }),
  '/app/line-sort-dedupe': dynamic(() => import('@/app/app/line-sort-dedupe/page'), { ssr: false, loading }),
  '/app/string-inspector': dynamic(() => import('@/app/app/string-inspector/page'), { ssr: false, loading }),
  '/app/escape-encode': dynamic(() => import('@/app/app/escape-encode/page'), { ssr: false, loading }),
  '/app/bcrypt-generator': dynamic(() => import('@/app/app/bcrypt-generator/page'), { ssr: false, loading }),
  '/app/chmod-calculator': dynamic(() => import('@/app/app/chmod-calculator/page'), { ssr: false, loading }),
  '/app/code-screenshot': dynamic(() => import('@/app/app/code-screenshot/page'), { ssr: false, loading }),
  '/app/css-generators': dynamic(() => import('@/app/app/css-generators/page'), { ssr: false, loading }),
  '/app/exif-viewer': dynamic(() => import('@/app/app/exif-viewer/page'), { ssr: false, loading }),
  '/app/favicon-generator': dynamic(() => import('@/app/app/favicon-generator/page'), { ssr: false, loading }),
  '/app/json-diff': dynamic(() => import('@/app/app/json-diff/page'), { ssr: false, loading }),
  '/app/jsonpath-playground': dynamic(() => import('@/app/app/jsonpath-playground/page'), { ssr: false, loading }),
  '/app/keycode-inspector': dynamic(() => import('@/app/app/keycode-inspector/page'), { ssr: false, loading }),
  '/app/markdown-table-generator': dynamic(() => import('@/app/app/markdown-table-generator/page'), { ssr: false, loading }),
  '/app/timezone-converter': dynamic(() => import('@/app/app/timezone-converter/page'), { ssr: false, loading }),
  '/app/token-counter': dynamic(() => import('@/app/app/token-counter/page'), { ssr: false, loading }),
  '/app/webhook-tester': dynamic(() => import('@/app/app/webhook-tester/page'), { ssr: false, loading }),
  '/app/websocket-tester': dynamic(() => import('@/app/app/websocket-tester/page'), { ssr: false, loading }),
  '/app/whois-lookup': dynamic(() => import('@/app/app/whois-lookup/page'), { ssr: false, loading }),
