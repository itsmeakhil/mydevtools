...
export const routeConfig: Record<string, RouteConfig> = {
  ...
  '/app/string-case-converter': { title: 'String Case Converter', icon: CaseSensitive, namespace: 'StringCaseConverter' },
  '/app/line-sort-dedupe': { title: 'Line Sort & Dedupe', icon: ArrowDownAZ, namespace: 'LineSortDedupe' },
  '/app/string-inspector': { title: 'String Inspector', icon: ScanText, namespace: 'StringInspector' },
  '/app/escape-encode': { title: 'Escape / Encode', icon: Replace, namespace: 'EscapeEncode' },
  '/app/bcrypt-generator': { title: "Bcrypt Generator & Checker", icon: ShieldCheck, namespace: 'BcryptGenerator' },
  ...
  '/app/exif-viewer': { title: "EXIF Viewer & Remover", icon: ScanSearch, namespace: 'ExifViewer' },
  ...
  '/app/webhook-tester': { title: "Webhook Tester", icon: Webhook, namespace: 'WebhookTester' },
