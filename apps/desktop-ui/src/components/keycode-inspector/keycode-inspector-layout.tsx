        ...
        <div className="flex flex-col gap-4 lg:col-span-2">
          ...
          {current && (
            <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
              ...
              <FieldCard label={t('fields.keyCode')} value={current.keyCode} deprecated deprecatedLabel={t('deprecated')} />
              <FieldCard label={t('fields.which')} value={current.which} deprecated deprecatedLabel={t('deprecated')} />
              <FieldCard
